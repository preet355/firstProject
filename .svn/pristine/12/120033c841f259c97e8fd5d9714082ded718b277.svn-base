								...
								<div class="row">
									<div class="col-xs-12">
									 ...
									 <display:table  id="dynamic-table" class="table table-striped table-bordered table-hover" excludedParams="*" 
									  requestURI="" name="requisitionRequestsList"  
									   pagesize="${pageSize}" uid="tblPostList" cellspacing="0" >
									    ...
									    <display:column   property="designationOfPost" title="Designation" sortable="true"></display:column>
									    ...
									    <display:column   property="status" title="Status" sortable="true"></display:column>
										 <display:column title="Action">
										    <a  href="javascript:viewRequisitionForm('${tblPostList.idRequisition}')" title="Download pdf"><i class="fa fa-fw fa-file-pdf-o bigger-120"></i></a>
...
function test(){
	...
	//alert(tab.rows[0].cells[0].getElementsByTagName('a')[0].getAttribute("href"));
}
