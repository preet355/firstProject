...
<input type="hidden" id="pageSizeTotal" name="pageSizeTotal" value="${pageSizeTotal }" />
 ...
 id="tblPostListExport" cellspacing="0" requestURI="exportContents?pageSizeTotal=${pageSizeTotal}&&nAmeOfPost=${nAmeOfPost}&&nExtStep=${nExtStep}&&aDvtNo=${aDvtNo}&&mAcroStatus=${mAcroStatus}&&dEpartmentId=${dEpartmentId}&&toformat=Pdf"   export="true" defaultsort="1" sort="list" >
