	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				<li class="active">
							<a href="<c:url value="requisitionDashboard"/>"> <i
				...
				<li class=""><a href="<c:url value="allRegisteredRequisitions"/>"> <c:set
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<input type="hidden" name="mAcroStatus" id="mAcroStatus" />
                               ...
                               <c:choose>
                                 <c:when test="${var=='req' && user.idRole=='1'}">
									...
									<div class="center">
										<a class="btn btn-app btn-grey btn-sm1 btn"
											href="<c:url value="allRegisteredRequisitions "/>"> <span
											class="line-height-1 smaller-90">Total Requisitions</span> <br />
											<span class="line-height-1 bigger-170 ">
												${totalRequisitionCount}</span> <span
											class="tooltiptext"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1"> ${totalRequisitionNoOFPostsCount} </span>
										</span>
										</a>
									...
									<div class="center">
										<a class="btn btn-app btn-sm btn btn-success no-hover"
											href="javascript:showStatusSearch('Advertised')"> <span
											class="line-height-1 bigger-170 ">
												${totalReqAdvertisedCount} </span> <br /> <span
											class="line-height-1 smaller-90">In Process</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalReqAdvertisedNoOfPostCount} </span>
										</span>
										</a> <a class="btn btn-app btn btn-sm btn-danger no-hover"
											style="color: #960303;"
											href="javascript:showStatusSearch('submitted')"> <span
											class="line-height-1 bigger-170">
												${totalNewRequisitionCount}</span> <br /> <span
											class="line-height-1 smaller-90">New</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalNewRequisitionNoOfPostsCount} </span>
										</span>
										</a>
										
										<a class="btn btn-app btn btn-sm btn-info no-hover"
											style="color: #960303;"
											href="javascript:showStatusSearch('back referred')"> <span
											class="line-height-1 bigger-170">
												${totalBackReferredCount}</span> <br /> <span
											class="line-height-1 smaller-90">Back referred</span> <span		
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalBackReferredPostsCount} </span>
										</span>
										</a>
										
										<a class="btn btn-app btn btn-sm btn-pink no-hover"
											style="color: #960303;"
											href="javascript:showStatusSearch('re-submitted')"> <span
											class="line-height-1 bigger-170">
												${totalReSubRequisitionCount}</span> <br /> <span
											class="line-height-1 smaller-90">Resubmitted</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalReSubRequisitionPostsCount} </span>
										</span>
										</a>
										
										<a class="btn btn-app btn-sm btn-light no-hover"
											href="javascript:showStatusSearch('approved')"> <span
											class="line-height-1 bigger-170 ">
                                ...
                                <c:choose>
                                 <c:when test="${var=='req' && user.idRole=='2'}">
									...
									<div class="center">
									<br><br><br><br>
									<a class="btn btn-app btn btn-sm btn-grey no-hover"
											href="#"> <span
											class="line-height-1 bigger-170 ">
												${totalReqRegisteredUsersCount}</span> <br /> <span
											class="line-height-1 smaller-90">Registered Departments</span> <%-- <span
											class="tooltiptextReccom"> <b>${totalReqRegisteredUsersCount}</b> <br>
												<span class="line-height-1">
													${totalSavedRequisitionPostsCount} </span>
										</span> --%>
										</a>
										...
										<a class="btn btn-app btn-sm btn btn-success no-hover"
											href="#"> <span
											class="line-height-1 bigger-170 ">
												${totalSavedRequisitionCount} </span> <br /> <span
											class="line-height-1 smaller-90">Saved Requisitions</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalSavedRequisitionPostsCount} </span>
										</span>
											...
											href="#"> <span
											class="line-height-1 bigger-170">
												${totalSubReSubCount}</span> <br /> <span
											class="line-height-1 smaller-90">Submitted Requisitions</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalSubReSubRequisitionPostsCount} </span>
										</span>
										</a>
										<a class="btn btn-app btn-sm btn-light no-hover"
											href="#"> <span
											class="line-height-1 bigger-170 ">
												${totalBackReferredCount} </span> <br /> <span
											class="line-height-1 smaller-90">Back Referred Requisitions</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalBackReferredPostsCount} </span>
										</span>
										...
										<a class="btn btn-app btn-sm btn-light no-hover"
											...
											class="line-height-1 bigger-170 ">
												${totalApprovedCount} </span> <br /> <span
											class="line-height-1 smaller-90">Approved Requisitions</span> <span
											class="tooltiptextReccom"> <b>Total No. of Posts</b> <br>
												<span class="line-height-1">
													${totalApprovedNoOfPostsCount} </span>
										</span>
						...
						<c:set var="var" value="${module}"/>
						<c:choose>
						<c:when test="${module=='req' && user.idRole=='1'}">
...
function macrostatusWiseData(){
	...
	document.getElementById('depListForm').action = "requisitionDashboard";
	document.getElementById('depListForm').submit();
