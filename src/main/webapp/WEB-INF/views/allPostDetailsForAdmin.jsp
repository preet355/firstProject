			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<ul class="nav ace-nav">
						...
						<ul class="breadcrumb">
							<h4 class="header smaller lighter blue" style="margin-bottom: 3px;margin-top:3px;">Advertisement Details</h4>
						</ul><!-- /.breadcrumb -->
					</div>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12" style="font-size:12px">
									 <form:form method="post" name="postForm" id="postDetailsForm" commandName="policeObj"> 
									 ...
									 <input type="hidden" name="sRNo" id="sRNo" value="${postDetailsList[0].sRNo }"/>
									   <table id="postDetailstbl" class="table  table-bordered table-hover">
											...
											<tr>
													...
													<td> <input type="text" name="deptObj.dEpartment" value="${deptName}" disabled>
													<span id="Error"></span>
													</td>
													<th class="blue">Name of Post</th>
													<td><input type="text" name="nAmeOfPost" value="${postDetailsList[0].nAmeOfPost}">
													<span id="Error1"></span>
													</td>
													<th class="blue">Advt. No.</th>
													<td><input type="text" name="aDvtNo" value="${postDetailsList[0].aDvtNo}">
													<span id="Error2"></span>
													</td>													
												...
												<tr>
													...
													<td><input type="text" name="mAcroStatus" value="${postDetailsList[0].mAcroStatus}"></td>
													
												</tr>
												<tr>
													<th class="blue">Next Step</th>
													<td><input type="text" name="nExtStep" value="${postDetailsList[0].nExtStep}"></td>
												...
												<tr>
													...
													<td>
													<input type="date" name="aDvertisementPosted" value="${postDetailsList[0].aDvertisementPosted}">
													</td>
													
													<th class="blue">Applications Open</th>
													<td><input type="date" name="aPplicationsOpen" value="${postDetailsList[0].aPplicationsOpen}"></td>
													<th class="blue">Applications Close</th>
													<td><input type="date" name="aPplicationsClose" value="${postDetailsList[0].aPplicationsClose}"></td>
													
												</tr>
												
												<tr>
													<th class="blue">Admit Cards</th>
													<td><input type="date" name="aDmitCards" value="${postDetailsList[0].aDmitCards}"></td>
													<th class="blue">PST Start (For Police only)</th>
													<td><input type="date" name="pStStart" value="${postDetailsList[0].pStStart}"></td>
													<th class="blue">PST End (For Police only)</th>
													<td><input type="date" name="pStEnd" value="${postDetailsList[0].pStEnd}"></td>
													
												</tr>
												
												<tr>
													<th class="blue">Result of PST (For Police only)</th>
													<td><input type="date" name="rEsultOfPst" value="${postDetailsList[0].rEsultOfPst}"></td>
													<th class="blue">Written Exam</th>
													<td><input type="date" name="wRittenExam" value="${postDetailsList[0].wRittenExam}"></td>
													<th class="blue">Written Exam Session</th>
													<td><input type="text" name="wRittenExamSession" value="${postDetailsList[0].wRittenExamSession}"></td>
													
												</tr>
												<tr>
													<th class="blue">Uploading Answer Key</th>
													<td><input type="date" name="uPloadingAnswerKey" value="${postDetailsList[0].uPloadingAnswerKey}"></td>
													<th class="blue">Objections Open</th>
													<td><input type="date" name="oBjectionsOpen" value="${postDetailsList[0].oBjectionsOpen}"></td>
													<th class="blue">Objections Close</th>
													<td><input type="date" name="oBjectionsClose" value="${postDetailsList[0].oBjectionsClose}"></td>
													
												</tr>
												<tr>
													<th class="blue">Uploaded Revised Answer Key</th>
													<td><input type="date" name="uPloadedRevisedAnswerKey" value="${postDetailsList[0].uPloadedRevisedAnswerKey}"></td>
													<th class="blue">Result of Written Exam</th>
													<td><input type="date" name="rEsultOfWrittenExam" value="${postDetailsList[0].rEsultOfWrittenExam}"></td>
													<th class="blue">Scrutiny Start Date</th>
													<td><input type="date" name="sCrutinyStartDate" value="${postDetailsList[0].sCrutinyStartDate}"></td>
													
												</tr>
												<tr>
													<th class="blue">Scrutiny End Date</th>
													<td><input type="date" name="sCrutinyEndDate" value="${postDetailsList[0].sCrutinyEndDate}"></td>
													<th class="blue">Scrutiny Results</th>
													<td><input type="date" name="sCrutinyResults" value="${postDetailsList[0].sCrutinyResults}"></td>
													<th class="blue">PMT Height-Chest (For Police only)</th>
													<td><input type="date" name="pMtHeightChest" value="${postDetailsList[0].pMtHeightChest}"></td>
													
												</tr>
												<tr>
													<th class="blue">Result of PMT Height-Chest (For Police only)</th>
													<td><input type="date" name="rEsultOfPmtHeightChest" value="${postDetailsList[0].rEsultOfPmtHeightChest}"></td>
													<th class="blue">Admit Cards (for Interview)</th>
													<td><input type="date" name="aDmitCardsForInterview" value="${postDetailsList[0].aDmitCardsForInterview}"></td>
                                                    <th class="blue">Interviews Start Date</th>
													<td><input type="date" name="iNterviewsStartDate" value="${postDetailsList[0].iNterviewsStartDate}"></td>
													
												</tr>
												<tr>
													<th class="blue">Interviews End Date</th>
													<td><input type="date" name="iNterviewsEndDate" value="${postDetailsList[0].iNterviewsEndDate}"></td>
													<th class="blue">Announcement of Final Result </th>
													<td><input type="date" name="aNnouncementOfFinalResult" value="${postDetailsList[0].aNnouncementOfFinalResult}"></td>
													<th class="blue">Recommended Date</th>
													<td><input type="date" name="rEcommendedDate" value="${postDetailsList[0].rEcommendedDate}"></td>					
												...
												<th class="blue">No. Of People Attending Exam</th>
													<td><input type="text" name="nOOfPeopleAttendingExam" value="${postDetailsList[0].nOOfPeopleAttendingExam}"></td>										
												</tr>
												</table>
                                     <center> <a class="btn btn-sm btn-warning" href="javascript:saveDetails('${postDetailsList[0].dEpartmentId}');">SAVE</a></center>
...
function saveDetails(dEpartmentId){
  //  var departName=document.postForm.deptObj.dEpartment.value;
